...
import 'package:flutter_dictionary_app/models/modelsAPI.dart';
import 'package:http/http.dart' as http;

class MyTranslateText extends StatefulWidget {
  const MyTranslateText({Key? key}) : super(key: key);

  @override
  State<MyTranslateText> createState() => _MyTranslateTextState();
}

class _MyTranslateTextState extends State<MyTranslateText> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Translate Text Page'),
      ),
      body: Column(
        children: <Widget>[
          Container(
